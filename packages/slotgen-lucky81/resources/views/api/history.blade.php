...
<body>
    <div class="transaction">
        ...
        <div class="transaction__header">
            ...
            <span class="transaction__title">Lucky 81</span>
                            ...
                            winresult = winresult + `
                                <div class="transaction__entry">
                                                ...
                                                <div class="transaction__field">
                                                    ...
                                                    <div class="pattern" style="grid-template-columns: repeat(4, 1fr)">
                                                        ` + lineResult + `
                                                    </div>


                                                    <div class="field field--lines" style="grid-template-columns: repeat(4, 1fr)">
                                                        ` + symbolWinResult + `
                                                    </div>
                                                </div>
                        ...
                        spin = spin + `
                                <div class="transaction__card">
                                    ...
                                    <div class="transaction__data">
                                        ...
                                        <div class="field " style="grid-template-columns: repeat(4, 1fr)">
                                            ` + resultSymbol + `
                                        </div>
                                    </div>
