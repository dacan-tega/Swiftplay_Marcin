...
namespace Slotgen\SlotgenLucky81\Filament\Pages;
...
use Slotgen\SlotgenLucky81\Models\SlotgenGame;
use Yepsua\Filament\Forms\Components\RangeSlider;
use ZipArchive;

class SlotgenLucky81ConfigPage extends Page
{
    use InteractsWithForms;

    protected static ?string $navigationIcon = 'heroicon-o-document-text';

    protected static string $view = 'slotgen-lucky81::filament.pages.config-page';

    public ?array $data = [];

    public SlotgenLucky81Config $setting;

    public function mount(): void
    {
        $rtpConfig = SlotgenLucky81Config::first();
        if (!empty($rtpConfig)) {
    ...
    public function submit(): void
    {
        ...
        try {
            // dd($this->data);
            $setting = SlotgenLucky81Config::first();
            if (!empty($setting)) {
                ...
                // dd($this->data);
                if (SlotgenLucky81Config::create($this->data)) {
                    Notification::make()
                        ->title('Setting add')
    ...
    public function extractFile($fileName, $language = "en")
    {
        ...
        if ($folder != null) {
            ...
            // $data = [
            //     'game_name'        => $name,
            //     'game_class'     => "Slotgen\\SlotgenLucky81\\SlotgenLucky81",
            // ];
            // $slotgen->fill($data);
            // $slotgen->save();
            $gamePrivateFolder = storage_path('app/private/lucky_81');
            $localtionStorage = 'app/private/lucky_81';
            ...
            //File::copy(__DIR__ . '/../../../resources/games/lucky81-logo.png', $gamePublicFolder . '/lucky81-logo.png');
        } 
    }
}
