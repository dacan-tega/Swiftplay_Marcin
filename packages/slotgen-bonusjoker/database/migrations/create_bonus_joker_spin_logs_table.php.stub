...
return new class extends Migration
{
    ...
    {
        Schema::create('slotgen_bonus_joker_spin_logs', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('total_way')->default(0);
    ...
    {
        Schema::dropIfExists('slotgen_bonus_joker_spin_logs');
    }
};
