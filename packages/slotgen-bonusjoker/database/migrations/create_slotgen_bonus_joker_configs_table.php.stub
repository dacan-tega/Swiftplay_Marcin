...
return new class extends Migration
{
    ...
    {
        Schema::create('slotgen_bonus_joker_configs', function (Blueprint $table) {
            $table->id();
            ...
            $table->tinyInteger('jackpot_value')->default(0);
            $table->tinyInteger('jackpot_win_ratio')->default(0);
            $table->decimal('jackpot_return_value_ratio', 18, 3);            
        ...
        DB::table('slotgen_bonus_joker_configs')->insert(
            [
                'win_ratio' => 50,
                'feature_ratio' => 50,
                'feature_winvalue' => 50,
    ...
    {
        Schema::dropIfExists('slotgen_bonus_joker_configs');
    }
};
