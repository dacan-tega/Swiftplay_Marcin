...
<style>
    ...
    .history-button {
        width: calc(var(--construct-scale) *106px);
        height: calc(var(--construct-scale) *106px);
        ...
        position: fixed;
        right: calc(var(--construct-scale) *280px);
        bottom: calc(var(--construct-scale) *10px);
    ...
    #root {
        transform: scale(calc(var(--construct-scale) *1.6));
        transform-origin: left top;
    }

    .LinesSlot .ReelsSlot__Reel {
        height: auto;
        width: 55px;
    }
</style>
...
<body class="Body--scaled">
    ...
    <div id="root">
        <div class="App App__Jurisdiction--UK" style="width: 100%; height: 100%;">
            <h3 class="GameTitle">Big Bass Bonanza</h3>
            <div class="Session-Table-Container">
                <table class="Table">
                    <thead class="Table__Header">
                        <tr class="Table__Row Table__Row--header">
                            <td class="Table__Cell Table__Cell--header"> </td>
                            <th class="Table__Cell Table__Cell--header Table__Cell--roundId"><span class="Table__Cell--header_text_container"><span class="Table__Cell--header_text">Play Session ID #</span></span></th>
                            <th class="Table__Cell Table__Cell--header Table__Cell--dateTime"><span class="Table__Cell--header_text_container"><span class="Table__Cell--header_text">Date</span></span></th>
                            <th class="Table__Cell Table__Cell--header Table__Cell--balance"><span class="Table__Cell--header_text_container"><span class="Table__Cell--header_text">New Balance</span></span></th>
                            <th class="Table__Cell Table__Cell--header Table__Cell--bet"><span class="Table__Cell--header_text_container"><span class="Table__Cell--header_text">Bet</span></span></th>
                            <th class="Table__Cell Table__Cell--header Table__Cell--win Table__Cell--align-right"><span class="Table__Cell--header_text_container"><span class="Table__Cell--header_text">Amount Won</span></span></th>
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(data) {
                                            ...
                                            for (let d = 0; d < item.result_json.length; d++) {
                                                var freeMode = item.result_json[d].free_spin;
                                                var countWild = item.result_json[d].count_wild
                                                var symbolWin = item.result_json[d].symbol_win ? item.result_json[d].symbol_win : 0;
                                                var reel = "";
                                                var progressLevel = "";
                                                var image = "";
                                                var actionFree = "";
                                                titlespin = drop == 0 ? "Spin" : "FreeSpin " + d;
                                                // freeMode = true;
                                                if (freeMode) {
                                                    for (let e = 0; e < 10; e++) {
                                                        if (e < countWild) {
                                                            if (e == 3) {
                                                                image = image + `<img src="/uploads/games/${gameName}/symbols/win_0.png"
                                                                    srcset="/uploads/games/${gameName}/symbols/win_0.png 1x"
                                                                    alt="progress/man.png" class="Progress__Item Progress__Item--active">`
                                                            }
                                                            if (e == 7) {
                                                                image = image + `<img src="/uploads/games/${gameName}/symbols/win_1.png"
                                                                    srcset="/uploads/games/${gameName}/symbols/win_1.png 1x"
                                                                    alt="progress/man.png" class="Progress__Item Progress__Item--active">`
                                                            }
                                                            if (e == 11) {
                                                                image = image + `<img src="/uploads/games/${gameName}/symbols/win_2.png"
                                                                    srcset="/uploads/games/${gameName}/symbols/win_2.png 1x"
                                                                    alt="progress/man.png" class="Progress__Item Progress__Item--active">`
                                                            } else {
                                                                image = image + `<img src="/uploads/games/${gameName}/symbols/man.png"
                                                                    srcset="/uploads/games/${gameName}/symbols/man.png 1x"
                                                                    alt="progress/man.png" class="Progress__Item Progress__Item--active">`
                                                            }
                                                            ...
                                                            if (e == 3) {
                                                                image = image + `<img src="/uploads/games/${gameName}/symbols/win_0.png"
                                                                    srcset="/uploads/games/${gameName}/symbols/win_0.png 1x"
                                                                    alt="progress/man.png" class="Progress__Item Progress__Item">`
                                                            }
                                                            if (e == 6) {
                                                                image = image + `<img src="/uploads/games/${gameName}/symbols/win_1.png"
                                                                    srcset="/uploads/games/${gameName}/symbols/win_1.png 1x"
                                                    ...
                                                    progressLevel = progressLevel + `<div class="Progress__Level">` + image + `</div>`;

                                                    for (let d = 0; d < 3; d++) {
                                                        actionFree = `<div class="Progress">` + progressLevel + `</div>`;
                                                    }
                                                }
                                                action = `
                                                <div class="Action" data-id="${id}_${drop}">
                                                ...
                                                <div class="Spin">
                                                    <div class="LinesSlot ">` + actionFree +
                                                    `<div class="SlotWrap">
                                                ...
                                                for (let i = 0; i < item.result_json[d]['drop_position'].length; i++) {
                                                    var winDrop = item.result_json[d]['drop_position'];
                                                }
                                                ...
                                                for (let i = 0; i < lastReel.length; i++) {
                                                    ...
                                                    for (let j = 0; j < lastReel[i].length; j++) {
                                                        var check = i + j * 5;
                                                        if (lastReel[i][j].search(":") > 0) {
                                                            var symbolMoney = lastReel[i][j].split(":");
                                                            // if (numberMulti[0] < 10) {
                                                            //     var symbolMulti = 12;
                                                            // } else if (numberMulti[0] >= 10 && numberMulti[0] < 40) {
                                                            //     var symbolMulti = 13;
                                                            // } else if (numberMulti[0] >= 40 && numberMulti[0] < 91) {
                                                            //     var symbolMulti = 14;
                                                            // } else {
                                                            //     var symbolMulti = 15;
                                                            // }
                                                            symbolreel = symbolreel + ` <div class="MoneyScatter "><img src="/uploads/games/${gameName}/symbols/${symbolMoney[0]}.png" srcset="" alt="${symbolMoney[0]}" class="ReelsSlot__ItemImg">
                                                                <div class="MoneyScatter__LabelWrap">
                                                                    <div class="MoneyScatter__Label" style="font-size: clamp(0px, 55.3px, 11.06px);margin-top:26px">${symbolMoney[1]}</div>
                                                            ...
                                                            if (winDrop.includes(check + 1)) {
                                                                symbolreel = symbolreel + `<div class="ReelsSlot__Item ReelsSlot__Item--position-${check}">
                                                                    <div class="Animation Animation__CrossFade ">
                                                                        <div class=""><img src="/uploads/games/${gameName}/symbols/${lastReel[i][j]}.png" srcset="" alt="10" class="ReelsSlot__ItemImg"></div>
                                                                    </div>
                                                                </div>`
                                                            } else {
                                                ...
                                                for (let m = 0; m < symbolWin.length; m++) {
                                                    var windropSymbol = symbolWin[m].position;
                                                    var line = symbolWin[m].line;
                                                    var winLine = symbolWin[m].win;
                                                    var reelPosition = "";
                                                    for (let i = 0; i < lastReel.length; i++) {
                                                        var symbolreel = "";
                                                        var winPosition = "";
                                                        for (let j = 0; j < lastReel[i].length; j++) {
                                                            ...
                                                            if (lastReel[i][j].search(":") > 0) {
                                                                var symbolMoney = lastReel[i][j].split(":");
                                                                if (windropSymbol.includes(check + 1)) {
                                                                    winPosition = winPosition + ` <div class="MoneyScatter ReelsSlot__Item--win"><img src="/uploads/games/${gameName}/symbols/${symbolMoney[0]}.png" srcset="" alt="${symbolMoney[0]}" class="ReelsSlot__ItemImg">
                                                                <div class="MoneyScatter__LabelWrap">
                                                                    <div class="MoneyScatter__Label" style="font-size: clamp(0px, 55.3px, 11.06px);margin-top:26px">${symbolMoney[1]}</div>
                                                                    <div class="MoneyScatter__Money" style="font-size: clamp(0px, -275px, 11px);"></div>
                                                                </div>
                                                            ...
                                                            `;
                                                                    ...
                                                                    winPosition = winPosition + ` <div class="MoneyScatter"><img src="/uploads/games/${gameName}/symbols/${symbolMoney[0]}.png" srcset="" alt="${symbolMoney[0]}" class="ReelsSlot__ItemImg">
                                                                <div class="MoneyScatter__LabelWrap">
                                                                    <div class="MoneyScatter__Label" style="font-size: clamp(0px, 55.3px, 11.06px);margin-top:26px">${symbolMoney[1]}</div>
                                                                    <div class="MoneyScatter__Money" style="font-size: clamp(0px, -275px, 11px);"></div>
                                                                </div>
                                                            ...
                                                            `;
                                                                ...
                                                                if (windropSymbol.includes(check + 1)) {
                                                                    winPosition = winPosition + `<div class="ReelsSlot__Item ReelsSlot__Item--position-${check} ReelsSlot__Item--win">
                                                                    <div class="Animation Animation__CrossFade ">
                                                                        <div class=""><img src="/uploads/games/${gameName}/symbols/${lastReel[i][j]}.png" srcset="" alt="10" class="ReelsSlot__ItemImg"></div>
                                                                    </div>
                                                                </div>`
                                                    ...
                                                    reelPositionTotal = reelPositionTotal + `<div class="LinesSlot ">
                                                                                        <div class="SlotWrap">
                                                                                            <div class="SlotWrap__Header">
                                                                                                <div class="WinLineWin">฿${winLine}</div>
                                                                                            </div>
                                                                                            <div class="SlotWrap__Field">` +
                                                        reelPosition +
                                                        `</div>
                                                                                            <div class="SlotWrap__Footer">Line: ${line}</div>
                                                                                            <div class="SlotWrap__Header">
                                                                                                <div class="WinLineWin">Line: ${line}</div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>`
                                                }
                                                var winPosition = '';
                                                if (totalWin > 0) {
                                                    winPosition = `<div class="WinLines__DlgLink WinPosition" data-id="${id}">Win Positions</div>`;
                                                }
                                                action = action + reel + ` </div>
                                                    ...
                                                    <div class="Action__Result">
                                                        <div class="Action__ResultItem Action__ResultItem--win">
                                                            <div class="Action__ResultValue">${totalWin}</div>
                                                            <div class="Action__ResultLabel">Win</div>
                                                        </div>
                                                        <div class="Action__ResultItem ">
                                                            <div class="Action__ResultValue"></div>
                                                            <div class="Action__ResultLabel">Tumbling Win: ${winMulti}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="Action__Footer Hbox">` +
                                                    winPosition +
                                                    `<div class="WinLines__DlgLink WinLines__DlgLink--paylines Lines" data-id="${id}">Lines</div>
                                                </div>
                                            </div>`;
                                            ...
                                            // $(".WinPosition", history).unbind('click');
                                            // $(".Lines", history).unbind('click');
                                            // $(modalRoot).unbind('click');
                                            // $(modalRoot1).unbind('click');
                                            ...
                                            $(".Lines", expandItem).on("click", function() {
                                                $(modalRoot1).empty();
                                                reelS1 = `<div class="Modal">
                                                <div class="Dialog" tabindex="0">
                                                        <div class="Dialog__TopBar">
                                                            <div class="Dialog__Title">Lines</div>
                                                            <div class="Dialog__TopButtons">
                                                                <div class="BtnAction BtnAction__Close"><svg class="BtnAction__Icon" viewBox="0 0 24 24">
                                                        ...
                                                        <div class="Dialog__Content">
                                                            <div class="PossibleWinLines-Block ">
                                                                <div class="PossibleWinLines">
                                                                    <div class="PossibleWinLines__WinLine">
                                                                        <div class="SlotWrap">
                                                                            <div class="SlotWrap__Field1">
                                                                                <div class="Slot__Row">
                                                                                ...
                                                                                <div class="Slot__Row">
                                                                                    <div class="Slot__Item Slot__Item--win">
                                                                                        <div class="empty-slot"></div>
                                                                                    </div>
                                                                                    <div class="Slot__Item Slot__Item--win">
                                                                                        <div class="empty-slot"></div>
                                                                            ...
                                                                            <div class="SlotWrap__Footer">Line: 1</div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="PossibleWinLines__WinLine">
                                                                        <div class="SlotWrap">
                                                                            ...
                                                                            <div class="SlotWrap__Footer">Line: 2</div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="PossibleWinLines__WinLine">
                                                                        <div class="SlotWrap">
                                                                            ...
                                                                            <div class="SlotWrap__Footer">Line: 3</div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="PossibleWinLines__WinLine">
                                                                        <div class="SlotWrap">
                                                                            ...
                                                                            <div class="SlotWrap__Footer">Line: 4</div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="PossibleWinLines__WinLine">
                                                                        <div class="SlotWrap">
                                                                            ...
                                                                            <div class="SlotWrap__Footer">Line: 5</div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="PossibleWinLines__WinLine">
                                                                        <div class="SlotWrap">
                                                                            ...
                                                                            <div class="SlotWrap__Footer">Line: 6</div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="PossibleWinLines__WinLine">
                                                                        <div class="SlotWrap">
                                                                            ...
                                                                            <div class="SlotWrap__Footer">Line: 7</div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="PossibleWinLines__WinLine">
                                                                        <div class="SlotWrap">
                                                                            ...
                                                                            <div class="SlotWrap__Footer">Line: 8</div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="PossibleWinLines__WinLine">
                                                                        <div class="SlotWrap">
                                                                            ...
                                                                            <div class="SlotWrap__Footer">Line: 9</div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="PossibleWinLines__WinLine">
                                                                        <div class="SlotWrap">
                                                                            ...
                                                                            <div class="SlotWrap__Footer">Line: 10</div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
