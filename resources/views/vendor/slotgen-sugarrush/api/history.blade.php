...
<style>
    ...
    .Animation__CrossFadeItem {
        ...
        animation-timing-function: ease-in-out;
        animation-iteration-count: infinite;
        animation-duration: var(--animation--crossFade-duration, 6s);
        animation-direction: alternate;
        position: absolute
    }
...
<body class="Body--scaled">
    <div id="root">
        <div class="App App__Jurisdiction--UK" style="width: 100%; height: 100%;">
            <h3 class="GameTitle">Sugar Rush</h3>
                                    ...
                                    $.ajax({
                                        ...
                                        <div class="vs20olympgate">`;
                                            ...
                                            for (let d = 0; d < item.result_json.length; d++) {
                                                ...
                                                var arrayMulti = item.result_json[d]['array_multi'];
                                                ...
                                                var totalWin = 0;
                                                for (let e = 0; e < item.result_json[d]['win_drop'].length; e++) {
                                                    var totalWin = totalWin + item.result_json[d]['win_drop'][e]['win'] * item.result_json[d]['win_drop'][e]['multi']; 
                                                }
                                                // var totalWin = parseFloat(item.result_json[d]['win_total']);
                                                // var winMulti = item.result_json[d]['win_drop'].length == 0 ? 0 : totalWin * item.result_json[d]['win_drop'];
                                                var winMulti = totalWin;
                                                winTotal = item.result_json[d]['win_drop'].length == 0 ? parseFloat(winTotal) : parseFloat(winTotal + totalWin);
                                                ...
                                                for (let i = 0; i < lastReel.length; i++) {
                                                    ...
                                                    for (let j = 0; j < lastReel[i].length; j++) {
                                                        var check = i + j * lastReel[i].length;
                                                        var multiSymbol = arrayMulti[i][j];
                                                            ...
                                                            if (winDrop.includes(check + 1)) {
                                                                if (multiSymbol > 1) {
                                                                    symbolreel = symbolreel + `
                                                                        <div class="ReelsSlot__Item ReelsSlot__Item--position-${check}">
                                                                            <div class="Animation Animation__MultiCrossFade Animation__MultiCrossFade2 ">
                                                                                <div
                                                                                    class="Animation__MultiCrossFadeItem Animation__MultiCrossFade2Item Animation__MultiCrossFadeItem--0 Animation__MultiCrossFade2Item--0">
                                                                                    <img src="/uploads/games/${gameName}/symbols/tmb.png"
                                                                                        srcset="/uploads/games/${gameName}/symbols/tmb.png, /uploads/games/${gameName}/symbols/tmb.png" alt="tmb"
                                                                                        class="ReelsSlot__ItemImg"></div>
                                                                                <div
                                                                                    class="Animation__MultiCrossFadeItem Animation__MultiCrossFade2Item Animation__MultiCrossFadeItem--1 Animation__MultiCrossFade2Item--1">
                                                                                    <img src="/uploads/games/${gameName}/symbols/bg.png, /uploads/games/${gameName}/symbols/bg.png"
                                                                                        srcset="/uploads/games/${gameName}/symbols/bg.png, /uploads/games/${gameName}/symbols/bg.png, /uploads/games/${gameName}/symbols/bg.png, /uploads/games/${gameName}/symbols/bg.png" alt="bg"
                                                                                        class="Bg ">
                                                                                    <div class="MoneyScatter "><img src="/uploads/games/${gameName}/symbols/${lastReel[i][j]}.png"
                                                                                            srcset="/uploads/games/${gameName}/symbols/${lastReel[i][j]}.png, /uploads/games/${gameName}/symbols/${lastReel[i][j]}.png" alt="8"
                                                                                            class="ReelsSlot__ItemImg">
                                                                                        <div class="MoneyScatter__LabelWrap">
                                                                                            <div class="MoneyScatter__Label" style="font-size: calc(11px);">x${multiSymbol}</div>
                                                                                            <div class="MoneyScatter__Money" style="font-size: calc(0px);"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                if (multiSymbol > 1) {
                                                                    ...
                                                                    <div class="ReelsSlot__Item ReelsSlot__Item--position-${check}">
                                                                        <div class="Animation Animation__MultiCrossFade Animation__MultiCrossFade2 ">
                                                                            <div
                                                                                class="Animation__MultiCrossFadeItem Animation__MultiCrossFade2Item Animation__MultiCrossFadeItem--0 Animation__MultiCrossFade2Item--0">
                                                                                <img src="/uploads/games/${gameName}/symbols/${lastReel[i][j]}.png"
                                                                                    srcset="/uploads/games/${gameName}/symbols/${lastReel[i][j]}.png, /uploads/games/${gameName}/symbols/${lastReel[i][j]}.png" alt="7"
                                                                                    class="ReelsSlot__ItemImg"></div>
                                                                            <div
                                                                                class="Animation__MultiCrossFadeItem Animation__MultiCrossFade2Item Animation__MultiCrossFadeItem--1 Animation__MultiCrossFade2Item--1">
                                                                                <img src="/uploads/games/${gameName}/symbols/bg.png"
                                                                                    srcset="/uploads/games/${gameName}/symbols/bg.png, /uploads/games/${gameName}/symbols/bg.png" alt="bg"
                                                                                    class="Bg ">
                                                                                <div class="MoneyScatter "><img src="/uploads/games/${gameName}/symbols/${lastReel[i][j]}.png"
                                                                                        srcset="/uploads/games/${gameName}/symbols/${lastReel[i][j]}.png, /uploads/games/${gameName}/symbols/${lastReel[i][j]}.png" alt="7"
                                                                                        class="ReelsSlot__ItemImg">
                                                ...
                                                reelPositionTotal = reelPositionTotal + `<div class="LinesSlot ">
                                                                                        <div class="SlotWrap">
                                                                                            <div class="SlotWrap__Header">
                                                                                                <div class="WinLineWin">฿${winMulti}</div>
                                                                                            </div>
                                                                                            <div class="SlotWrap__Field">` +
                                                    reelPosition +
                                                    `</div>
                                                ...
                                                action = action + reel + ` </div>
                                                    ...
                                                    <div class="Action__Result">
                                                        <div class="Action__ResultItem Action__ResultItem--win">
                                                            <div class="Action__ResultValue">${parseFloat(winMulti).toFixed(2)}</div>
                                                            <div class="Action__ResultLabel">Win</div>
                                                        </div>
                                                        <div class="Action__ResultItem ">
                                                            <div class="Action__ResultValue"></div>
                                                            <div class="Action__ResultLabel">Tumbling Win: ${parseFloat(winTotal).toFixed(2)}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        `;
                                            ...
                                            $(".WinPosition", expandItem).on("click", function() {
                                                ...
                                                console.log("arrWinPosition", arrWinPosition);
                                                $(modalRoot).empty();
